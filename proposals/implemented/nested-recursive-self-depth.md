...
**Document:** `proposals/implemented/nested-recursive-self-depth.md`
**Status:** Implemented 2026-05-26 (as part of stdlib expansion round 2 slice 3). The depth field shipped as planned. The JsonValue extension pivoted to spliced variants — see the §3 pivot note for context. Verifier tests cover depth-0 (backward compat) and depth-1 nested cases; the encoder reads the depth from the node rather than hardcoding 0.
**Date:** 2026-05-26 (proposal and implementation)
**Concerns:** [`design/node-algebra.md`](../../design/node-algebra.md), [`impl-kotlin/core/src/main/kotlin/org/strand/core/Node.kt`](../../impl-kotlin/core/src/main/kotlin/org/strand/core/Node.kt), [`impl-kotlin/hashing/src/main/kotlin/org/strand/hashing/CanonicalEncoder.kt`](../../impl-kotlin/hashing/src/main/kotlin/org/strand/hashing/CanonicalEncoder.kt), [`impl-kotlin/verifier/`](../../impl-kotlin/verifier/), [`corpus/66-json-value-nested.json`](../../corpus/66-json-value-nested.json), [`impl-kotlin/interpreter/src/main/kotlin/org/strand/interpreter/Builtins.kt`](../../impl-kotlin/interpreter/src/main/kotlin/org/strand/interpreter/Builtins.kt), [`proposals/implemented/stdlib-expansion-round-2.md`](stdlib-expansion-round-2.md)
**Scope:** Small — N-042 RecursiveSelf gains an optional `depth: Int = 0` field; depth field works as designed for type-algebra resolution but a value-construction limitation forced the JsonValue extension to use spliced variants instead
