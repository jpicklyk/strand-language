...
- **Don't use this skill** for adding a new builtin to `interpreter/Builtins.kt` (small one-file change), adding a new corpus program over existing nodes (no new types), or fixing bugs in existing node behavior.
