...
- [`proposals/implemented/agent-native-capabilities.md`](../proposals/implemented/agent-native-capabilities.md) — ToolDef (N-044) tool-use protocol
...
- [`proposals/implemented/agent-native-capabilities.md`](../proposals/implemented/agent-native-capabilities.md) — extends node algebra with ToolDef (N-044)
