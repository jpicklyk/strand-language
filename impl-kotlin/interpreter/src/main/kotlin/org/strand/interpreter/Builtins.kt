...
object Builtins {
    ...
    /**
     * Pluggable credential resolution for external providers
     * (Q-037 LLMs, Q-038 vector stores). Default is
     * [EnvCredentialProvider] (reads from environment variables).
     * Tests install [InMemoryCredentialProvider] to inject keys
     * without touching the environment. Thread safety mirrors
     * [clock].
     */
    @Volatile
