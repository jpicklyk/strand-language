...
**Status:** Proposed (revised 2026-05-26: first revision moved to per-provider design after five-call analysis pass; second revision later the same day reverted effect categories to operation-shaped after a prior-art check)
...
**Status:** Proposed (revised 2026-05-26 to align with [Q-037](#Q-037)'s second revision on operation-shaped effect categories)
