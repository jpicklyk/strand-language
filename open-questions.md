...
**Status:** Proposed (three sub-slices landed 2026-05-24: full-coverage Layer A grammar + parser + emitter; 33 corpus programs in both forms with hash-equal round-trip; minimal Layer C effect-closure inference for `Lambda.effects`. Layer B grammar-constrained decoding, the other three Layer C inference cases, tokenizer alignment, and the Q-021 evaluation framework remain pending.)
...
**Status:** Proposed (first library — JSON — shipped 2026-05-24 in Layer 7 step 1.5 of the reference implementation; HTML5, SVG, PDF, plain text, Markdown remain to ship)
