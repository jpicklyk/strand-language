...
line 4: code 'PRF' at position 1 expected value-producing nested expression (code `RS` is type-only or structural) but got nested `(RS ...)`
...
Your program failed to compile. The error:
line 3: code 'RT' at position 0 expected value-producing nested expression (code `SUM` is type-only or structural) but got nested `(SUM ...)`
...
Your program failed to compile. The error:
Exception in thread "main" org.strand.core.IngestError: Unknown node id 'lst' referenced from node 'sumBody'.scrutinee
	...
	at org.strand.core.JsonIngest.buildNode(Json.kt:285)
...
Your program failed to compile. The error:
Exception in thread "main" org.strand.core.IngestError: Unknown node id '3' referenced from node '__pfv0_head'.value
	at org.strand.core.JsonIngest$parse$resolver$1.invoke-pXsIjU0(Json.kt:141)
	at org.strand.core.JsonIngest$parse$resolver$1.invoke(Json.kt:139)
	at org.strand.core.JsonKt.requireRef(Json.kt:540)
	at org.strand.core.JsonKt.access$requireRef(Json.kt:1)
	at org.strand.core.JsonIngest.buildNode(Json.kt:299)
	at org.strand.core.JsonIngest.buildStored(Json.kt:197)
	at org.strand.core.JsonIngest.parse(Json.kt:145)
	at org.strand.core.JsonIngest.parse(Json.kt:103)
	at org.strand.cli.MainKt.loadFinalizedWithIngest(Main.kt:42)
