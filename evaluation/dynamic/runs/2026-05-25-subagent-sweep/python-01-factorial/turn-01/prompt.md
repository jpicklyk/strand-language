# Turn 01 of session python-01-factorial

Task: `01-factorial` | Config: `python-type-hints` | Model: `claude-sonnet-4-7`
Attempt: 2 / 5
...
Error: program output did not match expected value.
expected: '120'
actual:   '3628800'
