# Turn 03 of session density-v4-18-schema-username-truncate-s0

Task: `18-schema-username-truncate` | Config: `strand-layer-a-density-v4` | Model: `claude-sonnet-4-6`
...
CategoryMismatch at #3: at=#3 'shortNameSchema' (line 5), field=Schema.invariants[0], expectedCategory=Invariant, actualCategory=Lambda
...
Your program failed to compile. The error:
line 4: code 'INV' expects 3..3 positional arguments but got 1
...
invBody IF (APP le [(APP strLen [s]) 8]) true false
invLam LAM [s:stringT] invBody
shortNameInv INV "lengthBound" stringT invLam
shortNameSchema SCH "ShortName" stringT [shortNameInv]
rawUsername APP concat ["strand" "_agent"]
username APP subStr [rawUsername 0 8]
identityResult APP (LAM [p:shortNameSchema] p) [username]
...
Your program failed to compile. The error:
InvariantTargetMismatch at #3: at=#3 'shortNameSchema' (line 5), invariant=#2 'shortNameInv' (line 4), targetSchema=#29 (prelude 'stringT'), declaringSchema=#3 'shortNameSchema' (line 5)
