...
# Recursive list type: inner/outer product split
# Inner product (used inside RT body): tail references RS
rsSelf RS
headFieldInner PRF "head" intT
tailFieldInner PRF "tail" rsSelf
consPayloadInner PRD [headFieldInner tailFieldInner]
consCase SCS "Cons" consPayloadInner
nilCase SCS "Nil" _
listSumT SUM [consCase nilCase]
listT RT listSumT

# Outer product (used at top-level value sites): tail references listT
headFieldOuter PRF "head" intT
tailFieldOuter PRF "tail" listT
consPayloadT PRD [headFieldOuter tailFieldOuter]
