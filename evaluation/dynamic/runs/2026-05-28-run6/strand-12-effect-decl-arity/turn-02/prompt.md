# Turn 02 of session strand-12-effect-decl-arity

Task: `12-effect-decl-arity` | Config: `strand-layer-a-density-v4` | Model: `claude-sonnet-4-7`
Attempt: 3 / 5
...
connectCall APP netConnect [host port] _ [callDecl]
...
line 8: code 'APP' at position 2 expected [ref ref ...] list but got null '_'
...
Your program failed to compile. The error:
NonEffectCategoryInEffectList at #9: at=#9, offendingChild=#2, actualCategory=ForeignNode
