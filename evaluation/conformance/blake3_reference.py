"""Vendored BLAKE3 pure-Python implementation (verbatim except this header).

Provenance:
  Source URL: https://github.com/oconnor663/pure_python_blake3/blob/main/pure_blake3.py
  Raw file:   https://raw.githubusercontent.com/oconnor663/pure_python_blake3/main/pure_blake3.py
  Commit:     3fde72eabfc6aa4ea7fa727bdfb852f396f90a17 (2022-09-29)
  License:    CC0-1.0 (public domain dedication)
  Author:     Jack O'Connor (BLAKE3 co-author); this is the Python port of the
              official Rust reference implementation linked from
              https://github.com/BLAKE3-team/BLAKE3/tree/master/reference_impl
              (the BLAKE3 repository itself ships only the Rust
              reference_impl.rs; its README points to this repository as the
              Python port).

Validated against the official BLAKE3 test vectors
(https://github.com/oconnor663/pure_python_blake3/blob/main/test_vectors.json,
identical to BLAKE3-team/BLAKE3 test_vectors.json): all 35 cases pass for the
default 32-byte hash. independent_encoder.py re-checks a subset at startup
before trusting this module.

Q-066 (proposals/implemented/adversarial-verification.md): the independent
canonical encoder uses this module so that no part of the conformance
pipeline shares code with the Kotlin reference implementation.
"""
